...
class AllFoodVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.storeImg.sd_setImage(with: tempUrl, placeholderImage: UIImage(named: "store\(indexPath.row)"))
        ...
        if indexPath.row == 0{
            ...
            cell.storeTitle.text = "The Domino's Petting Farm"
